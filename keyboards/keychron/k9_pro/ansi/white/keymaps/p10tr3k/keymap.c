...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_61_ansi(
        ...
        KC_LCTL,  KC_LWIN,  KC_LALT,                                FN_SPC,                                 KC_RALT, MO(WIN_FN),MO(L_FN1),KC_RCTL),
    ...
    [NUM] = LAYOUT_61_ansi(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  KC_MINS,  KC_7,      KC_8,    KC_9,     XXXXXXX,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  KC_PLUS,  KC_4,      KC_5,    KC_6,     KC_DOT,   _______,            _______,
        _______,            _______,  _______,  _______,  _______,  KC_ASTR,  KC_1,      KC_2,    KC_3,     KC_DOT,   _______,            _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______),
};
